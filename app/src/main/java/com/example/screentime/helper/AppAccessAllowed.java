...
public class AppAccessAllowed {
    ...
    public static Pair<Boolean,
        String> getStatusAppAccessAllowedNow(Context context, AppViewUsageStats appViewUsageStats,
        ...
        if (restrictionInfo.getIsSpecifiTimeRestrictionSet()) {
            ...
            for (int i = 0; i < beginTime.length; i++) {
                ...
                initial.set(Calendar.HOUR_OF_DAY, initialHour);
                initial.set(Calendar.MINUTE, initialMinute);
